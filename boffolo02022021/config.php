<?php
// Hackes
define('URL', $_SERVER['HTTP_HOST'] . str_replace('/boffolo02022021', '', dirname($_SERVER['PHP_SELF']))."/");
define('BASE_DIR', str_replace(DIRECTORY_SEPARATOR,"/",str_replace(DIRECTORY_SEPARATOR . "boffolo02022021", "", realpath(dirname(__FILE__))))."/");
// Dynamic Protocol Settings
$protocol = "http://";
if($_SERVER["SERVER_PORT"] == 443){	$protocol = "https://";}
// HTTP Protocol
define('HTTP_SERVER', $protocol . URL. 'boffolo02022021/');
define('HTTPS_SERVER', $protocol . URL. 'boffolo02022021/');
...
// Directory
define('DIR_APPLICATION', BASE_DIR. 'boffolo02022021/');
define('DIR_SYSTEM', BASE_DIR. 'system/');
define('DIR_IMAGE', BASE_DIR. 'image/');
define('DIR_LANGUAGE', BASE_DIR. 'boffolo02022021/language/');
define('DIR_TEMPLATE', BASE_DIR. 'boffolo02022021/view/template/');
...
define('DB_PASSWORD', '');
define('DB_DATABASE', 'boffolo_db');
define('DB_PORT', '3306');
define('DB_PREFIX', 'boffolo_');

define('BANNER_EXTRA', true);
define('ADVANCE_PASSWORD', false);
define('ADMIN_FOLDER', 'boffolo02022021');
