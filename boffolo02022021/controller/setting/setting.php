...
class ControllerSettingSetting extends Controller {
	...
	public function index() {
		...
		$data['entry_announcement'] = $this->language->get('entry_announcement');
		...
		$data['help_announcement'] = $this->language->get('help_announcement');
		...
		if (isset($this->request->post['config_announcement'])) {
			$data['config_announcement'] = $this->request->post['config_announcement'];
		} else {
			$data['config_announcement'] = $this->config->get('config_announcement');
		}
