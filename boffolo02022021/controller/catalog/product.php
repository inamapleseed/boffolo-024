...
class ControllerCatalogProduct extends Controller {
	...
	protected function getForm() {
		...
		if (isset($this->request->post['product_pdf_id2'])) {
					$data['product_pdf_id2'] = $this->request->post['product_pdf_id2'];
		} elseif (!empty($product_info)) {
			$data['product_pdf_id2'] = $product_info['product_pdf_id2'];
		} else {
			$data['product_pdf_id2'] = '';
		}
		if (isset($this->request->post['product_pdf_id3'])) {
					$data['product_pdf_id3'] = $this->request->post['product_pdf_id3'];
		} elseif (!empty($product_info)) {
			$data['product_pdf_id3'] = $product_info['product_pdf_id3'];
		} else {
			$data['product_pdf_id3'] = '';
		}
		if (isset($this->request->post['product_pdf_id4'])) {
					$data['product_pdf_id4'] = $this->request->post['product_pdf_id4'];
		} elseif (!empty($product_info)) {
			$data['product_pdf_id4'] = $product_info['product_pdf_id4'];
		} else {
			$data['product_pdf_id4'] = '';
		}
		if (isset($this->request->post['product_pdf_id5'])) {
					$data['product_pdf_id5'] = $this->request->post['product_pdf_id5'];
		} elseif (!empty($product_info)) {
			$data['product_pdf_id5'] = $product_info['product_pdf_id5'];
		} else {
			$data['product_pdf_id5'] = '';
		}
		...
		if (isset($this->request->post['filename2'])) {
			...
			$data['filename2'] = $product_info['filename2'];
		} else {
			$data['filename2'] = '';
		}
		...
		if (isset($this->request->post['filename3'])) {
			...
			$data['filename3'] = $product_info['filename3'];
		} else {
			$data['filename3'] = '';
		}
		...
		if (isset($this->request->post['filename4'])) {
			...
			$data['filename4'] = $product_info['filename4'];
		} else {
			$data['filename4'] = '';
		}
		...
		if (isset($this->request->post['filename5'])) {
			...
			$data['filename5'] = $product_info['filename5'];
		} else {
			$data['filename5'] = '';
		}
