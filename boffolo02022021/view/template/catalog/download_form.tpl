    ...
    <div class="panel panel-default">
      ...
      <div class="panel-body">
        <form action="<?php echo $action; ?>" method="post" enctype="multipart/form-data" id="form-download" class="form-horizontal">
          ...
          <div class="form-group required">
            <label class="col-sm-2 control-label" for="input-category"><span data-toggle="tooltip">Category</span></label>
            <div class="col-sm-10">
          ...
          <div class="form-group required">
            <label class="col-sm-2 control-label" for="input-description2"><span data-toggle="tooltip">Description 2</span></label>
            <div class="col-sm-10">
                <input type="text" name="description2" value="<?= $description2; ?>"  id="input-description2" class="form-control" />
            </div>
          </div>

          <div class="form-group required">
            <label class="col-sm-2 control-label" for="input-moreinfo"><span data-toggle="tooltip">More Info</span></label>
            <div class="col-sm-10">
                <input type="text" name="moreinfo" value="<?= $moreinfo; ?>"  id="input-moreinfo" class="form-control" />
            </div>
          </div>
