			...
			<div class="form-group">
                ...
                <div class="col-sm-10">
                  <div class="well well-sm" style="height: 150px; overflow: auto;">
                    ...
                    <div class="checkbox">
                      <label>
                        <?php if (in_array($category['ncategory_id'], $news_ncategory)) { ?><input type="checkbox" name="news_ncategory[]" class="<?php echo $category['name']; ?> checketh" value="<?php echo $category['ncategory_id']; ?>" checked="checked" /><?php echo $category['name']; ?><?php } else { ?><input type="checkbox" name="news_ncategory[]" value="<?php echo $category['ncategory_id']; ?>" /><?php echo $category['name']; ?>
                        <?php } ?>
                      </label>
                    </div>
                    <?php } ?>
...
<div class="tab-pane" id="tab-video">
 <div class="table-responsive">
	<table id="video" class="table table-striped table-bordered table-hover">
            <thead>
              <tr>
                <td class="text-left">Embed Youtube</td>
            ...
            <tbody id="video-row<?php echo $video_row; ?>">
              <tr>
                <td class="text-left">
					<input type="text" name="news_video[<?php echo $video_row; ?>][video]" value='<?php echo $video["video"]; ?>' size="100">
				</td>
				<td class="text-left">
...
function addVideo() {
	...
	html += '  <tr>';
	html += '    <td class="left"><input type="text" name="news_video[' + video_row + '][video]" value="" size="100"></td>';
	html += '    <td class="left">';
		<?php foreach ($languages as $language) { ?>
