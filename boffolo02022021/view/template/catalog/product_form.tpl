...
<div id="content">
				...
				<form action="<?= $action; ?>" method="post" enctype="multipart/form-data" id="form-product" class="form-horizontal">
					...
					<div class="tab-content">
						...
						<div class="tab-pane" id="tab-links">
							<!-- here -->
								<div class="form-group">
									<label class="col-sm-2 control-label" for="input-filename"><?= $entry_product_catalog; ?> 1</label>
									<div class="col-sm-10">
								...
								<div class="form-group">
									<label class="col-sm-2 control-label" for="input-filename2"><?= $entry_product_catalog; ?> 2</label>
									<div class="col-sm-10">
										<div class="input-group">
											<input type="text" name="mask2" value="<?php echo $mask2; ?>" placeholder="" id="input-filename2" class="form-control" />
											<span class="input-group-btn">
												<button type="button" id="button-upload2" data-loading-text="<?= $text_loading; ?>" class="btn btn-primary"><i class="fa fa-upload"></i> <?= $button_upload; ?></button>
											</span> 
											<input type="hidden" name="filename2" value="<?= $filename2; ?>" />
											<input type="hidden" name="product_pdf_id2" value="<?= $product_pdf_id2; ?>" />
										</div>
									</div>
								</div>

								<div class="form-group">
									<label class="col-sm-2 control-label" for="input-filename3"><?= $entry_product_catalog; ?> 3</label>
									<div class="col-sm-10">
										<div class="input-group">
											<input type="text" name="mask3" value="<?php echo $mask3; ?>" placeholder="" id="input-filename3" class="form-control" />
											<span class="input-group-btn">
												<button type="button" id="button-upload3" data-loading-text="<?= $text_loading; ?>" class="btn btn-primary"><i class="fa fa-upload"></i> <?= $button_upload; ?></button>
											</span> 
											<input type="hidden" name="filename3" value="<?= $filename3; ?>" />
											<input type="hidden" name="product_pdf_id3" value="<?= $product_pdf_id3; ?>" />
										</div>
									</div>
								</div>

								<div class="form-group">
									<label class="col-sm-2 control-label" for="input-filename4"><?= $entry_product_catalog; ?> 4</label>
									<div class="col-sm-10">
										<div class="input-group">
											<input type="text" name="mask4" value="<?php echo $mask4; ?>" placeholder="" id="input-filename4" class="form-control" />
											<span class="input-group-btn">
												<button type="button" id="button-upload4" data-loading-text="<?= $text_loading; ?>" class="btn btn-primary"><i class="fa fa-upload"></i> <?= $button_upload; ?></button>
											</span> 
											<input type="hidden" name="filename4" value="<?= $filename4; ?>" />
											<input type="hidden" name="product_pdf_id4" value="<?= $product_pdf_id4; ?>" />
										</div>
									</div>
								</div>

								<div class="form-group">
									<label class="col-sm-2 control-label" for="input-filename5"><?= $entry_product_catalog; ?> 5</label>
									<div class="col-sm-10">
										<div class="input-group">
											<input type="text" name="mask5" value="<?php echo $mask5; ?>" placeholder="" id="input-filename5" class="form-control" />
											<span class="input-group-btn">
												<button type="button" id="button-upload5" data-loading-text="<?= $text_loading; ?>" class="btn btn-primary"><i class="fa fa-upload"></i> <?= $button_upload; ?></button>
											</span> 
											<input type="hidden" name="filename5" value="<?= $filename5; ?>" />
											<input type="hidden" name="product_pdf_id5" value="<?= $product_pdf_id5; ?>" />
										</div>
									</div>
								</div>
	...
	$('#button-upload2').on('click', function() {
		...
		$('body').prepend('<form enctype="multipart/form-data" id="form-upload2" style="display: none;"><input type="file" name="file2" /></form>');
		
		$('#form-upload2 input[name=\'file2\']').trigger('click');
		...
		timer = setInterval(function() {
			if ($('#form-upload2 input[name=\'file2\']').val() != '') {
				clearInterval(timer);		
				
				$.ajax({
					url: 'index.php?route=catalog/download/upload2&token=<?php echo $token; ?>',
					type: 'post',		
					dataType: 'json',
					...
					success: function(json) {
						...
						if (json['success']) {
							...
							$('input[name=\'filename2\']').val(json['filename2']);
							$('input[name=\'mask2\']').val(json['mask2']);
						}
					},			
					error: function(xhr, ajaxOptions, thrownError) {
						alert(thrownError + "\r\n" + xhr.statusText + "\r\n" + xhr.responseText);
	...
	$('#button-upload3').on('click', function() {
		...
		$('body').prepend('<form enctype="multipart/form-data" id="form-upload3" style="display: none;"><input type="file" name="file3" /></form>');
		
		$('#form-upload3 input[name=\'file3\']').trigger('click');
		...
		timer = setInterval(function() {
			if ($('#form-upload3 input[name=\'file3\']').val() != '') {
				clearInterval(timer);		
				
				$.ajax({
					url: 'index.php?route=catalog/download/upload3&token=<?php echo $token; ?>',
					type: 'post',		
					dataType: 'json',
					...
					success: function(json) {
						...
						if (json['success']) {
							...
							$('input[name=\'filename3\']').val(json['filename3']);
							$('input[name=\'mask3\']').val(json['mask3']);
						}
					},			
					error: function(xhr, ajaxOptions, thrownError) {
						alert(thrownError + "\r\n" + xhr.statusText + "\r\n" + xhr.responseText);
	...
	$('#button-upload4').on('click', function() {
		...
		$('body').prepend('<form enctype="multipart/form-data" id="form-upload4" style="display: none;"><input type="file" name="file4" /></form>');
		
		$('#form-upload4 input[name=\'file4\']').trigger('click');
		...
		timer = setInterval(function() {
			if ($('#form-upload4 input[name=\'file4\']').val() != '') {
				clearInterval(timer);		
				
				$.ajax({
					url: 'index.php?route=catalog/download/upload4&token=<?php echo $token; ?>',
					type: 'post',		
					dataType: 'json',
					...
					success: function(json) {
						...
						if (json['success']) {
							...
							$('input[name=\'filename4\']').val(json['filename4']);
							$('input[name=\'mask4\']').val(json['mask4']);
						}
					},			
					error: function(xhr, ajaxOptions, thrownError) {
						alert(thrownError + "\r\n" + xhr.statusText + "\r\n" + xhr.responseText);
	...
	$('#button-upload5').on('click', function() {
		...
		$('body').prepend('<form enctype="multipart/form-data" id="form-upload5" style="display: none;"><input type="file" name="file5" /></form>');
		
		$('#form-upload5 input[name=\'file5\']').trigger('click');
		...
		timer = setInterval(function() {
			if ($('#form-upload5 input[name=\'file5\']').val() != '') {
				clearInterval(timer);		
				
				$.ajax({
					url: 'index.php?route=catalog/download/upload5&token=<?php echo $token; ?>',
					type: 'post',		
					dataType: 'json',
					...
					success: function(json) {
						...
						if (json['success']) {
							...
							$('input[name=\'filename5\']').val(json['filename5']);
							$('input[name=\'mask5\']').val(json['mask5']);
						}
					},			
					error: function(xhr, ajaxOptions, thrownError) {
						alert(thrownError + "\r\n" + xhr.statusText + "\r\n" + xhr.responseText);
