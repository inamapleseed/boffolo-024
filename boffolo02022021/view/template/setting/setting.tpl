      ...
      <form action="<?= $action; ?>" method="post" enctype="multipart/form-data" id="form-setting" class="form-horizontal">
        ...
        <div class="tab-content">
          ...
          <div class="tab-pane active" id="tab-general">
            ...
            <div class="form-group">
              <label class="col-sm-2 control-label" for="input-announcement"><span data-toggle="tooltip" data-container="#tab-general" title="<?= $help_announcement; ?>"><?= $entry_announcement; ?></span></label>
              <div class="col-sm-10">
                <textarea name="config_announcement" rows="5" placeholder="<?= $entry_announcement; ?>" id="input-announcement" class="form-control"><?= $config_announcement; ?></textarea>
              </div>
            </div>
            <div class="form-group">
