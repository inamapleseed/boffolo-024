...
// 			'checkbox'	=>	'',
				...
				if($this->config->get('pro_email_template_status')){
					...
					$email_params = array(
						...
						'data' => array(
							...
							'enquiry_position' => html_entity_decode($this->request->post['position'], ENT_QUOTES, 'UTF-8'),
		...
		protected function validate() {
			if($this->request->post['contact_form']){
				...
				if ((utf8_strlen($this->request->post['position']) < 3) || (utf8_strlen($this->request->post['position']) > 32)) {
