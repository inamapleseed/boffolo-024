...
class ModelCatalogProduct extends Model {
	...
	public function getProductDownload2($product_id = 0) {
		$product_id = (int)$product_id;

		$query = $this->db->query("SELECT DISTINCT product_pdf_id2 FROM " . DB_PREFIX ."product_pdf2 WHERE product_id='" .$product_id . "' LIMIT 0,1");
		if($query->num_rows){
			return $query->row['product_pdf_id2'];
		}
		return false;
	}
	public function getProductDownload3($product_id = 0) {
		$product_id = (int)$product_id;

		$query = $this->db->query("SELECT DISTINCT product_pdf_id3 FROM " . DB_PREFIX ."product_pdf3 WHERE product_id='" .$product_id . "' LIMIT 0,1");
		if($query->num_rows){
			return $query->row['product_pdf_id3'];
		}
		return false;
	}
	public function getProductDownload4($product_id = 0) {
		$product_id = (int)$product_id;

		$query = $this->db->query("SELECT DISTINCT product_pdf_id4 FROM " . DB_PREFIX ."product_pdf4 WHERE product_id='" .$product_id . "' LIMIT 0,1");
		if($query->num_rows){
			return $query->row['product_pdf_id4'];
		}
		return false;
	}
	public function getProductDownload5($product_id = 0) {
		$product_id = (int)$product_id;

		$query = $this->db->query("SELECT DISTINCT product_pdf_id5 FROM " . DB_PREFIX ."product_pdf5 WHERE product_id='" .$product_id . "' LIMIT 0,1");
		if($query->num_rows){
			return $query->row['product_pdf_id5'];
		}
		return false;
	}
	...
	public function getDownload2($product_pdf_id2 = 0) {
		$product_pdf_id2 = (int)$product_pdf_id2;

		$query = $this->db->query("SELECT DISTINCT mask2, filename2 FROM " . DB_PREFIX ."product_pdf2 WHERE product_pdf_id2='" .$product_pdf_id2 . "' LIMIT 0,1");
		if($query->num_rows){
			return $query->row;
		}
	...
	public function getDownload3($product_pdf_id3 = 0) {

		$product_pdf_id3 = (int)$product_pdf_id3;

		$query3 = $this->db->query("SELECT DISTINCT mask3, filename3 FROM " . DB_PREFIX ."product_pdf3 WHERE product_pdf_id3='" .$product_pdf_id3 . "' LIMIT 0,1");
		if($query3->num_rows){
			return $query3->row;
		}
	...
	public function getDownload4($product_pdf_id4 = 0) {
		$product_pdf_id4 = (int)$product_pdf_id4;
	
		$query4 = $this->db->query("SELECT DISTINCT mask4, filename4 FROM " . DB_PREFIX ."product_pdf4 WHERE product_pdf_id4='" .$product_pdf_id4 . "' LIMIT 0,1");
		if($query4->num_rows){
			return $query4->row;
		}
	...
	public function getDownload5($product_pdf_id5 = 0) {
		$product_pdf_id5 = (int)$product_pdf_id5;
	
		$query5 = $this->db->query("SELECT DISTINCT mask5, filename5 FROM " . DB_PREFIX ."product_pdf5 WHERE product_pdf_id5='" .$product_pdf_id5 . "' LIMIT 0,1");
		if($query5->num_rows){
			return $query5->row;
		}
