...
<script type="text/javascript">
  ...
  if (len < 768) {
    let html = $('.attr-set-cont').html();
    $('.attr-set-cont').hide();
    $('.attr-set-container').append(html);
    $('.attr-set-cont ul.nav-tabs').attr("id","");
    $('.attr-set-cont .tab-content .tab-pane').attr("id","");
  }
</script>
